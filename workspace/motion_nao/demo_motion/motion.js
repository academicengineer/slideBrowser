...
var session = new QiSession("192.168.11.18:80");
...
window.onload = function () {
    ...
    var rangeValue = function (elem, target) {
        return function (evt) {
            ...
            Elem = Number(document.getElementById('range').value);
            Elem2 = Number(document.getElementById('range2').value);
        }
...
function l_shoulder() {
    _motion.setAngles(["LShoulderPitch", "LShoulderRoll"], [Elem, Elem2], 0.1)
}

function clickBtn_ls() {
    l_shoulder();
}
